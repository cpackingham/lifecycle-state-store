...
var ShallowStateUpdate = function (_Store) {
  _inherits(ShallowStateUpdate, _Store);

  function ShallowStateUpdate() {
    _classCallCheck(this, ShallowStateUpdate);

    return _possibleConstructorReturn(this, (ShallowStateUpdate.__proto__ || Object.getPrototypeOf(ShallowStateUpdate)).apply(this, arguments));
  }
